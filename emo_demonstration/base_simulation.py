...
def setup_milling_sim(mode="gui"):
    file_directory = os.path.dirname(os.path.abspath(__file__))
    sdmbot_urdf_file = os.path.join(file_directory, 'urdf', 'sdmbot copy.urdf')
    ...
    if mode == "gui":
        ...
        p.configureDebugVisualizer(p.COV_ENABLE_GUI, 0)
        p.resetDebugVisualizerCamera(cameraDistance=0.8, cameraYaw=-90, cameraPitch=-25,
...
if __name__ == "__main__":
    ...
    robot, gripper, screwdriver, mill = setup_milling_sim()

...
if __name__ == "__main__":
    ...
    robot, gripper, screwdriver, milling_tool = setup_base_sim(tool_mode="milling")
    for _ in range(100):
        p.stepSimulation()
    ...
    execute_milling(milling_tool, spawn_point, "C:\MaH\Python\disassembly_sequence_generator\planning_results\\tool_path_0_1.txt")
